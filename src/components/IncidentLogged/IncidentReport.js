...
//tag
    ...
    const tProps = {
      ...
      return (
        ...
        <Button type="primary" shape="round" onClick={this.showModal} style={{ background: "#e65c00", borderColor: "black" }}>
        ...
        >
         ...
         <b>Message</b><br></br>
           ...
           &nbsp;&nbsp;
           <Button type="link" shape="round" ><PaperClipOutlined style={{ fontSize: '25px', color: 'black' }} /></Button><br></br><br></br>
       <center> <Button block shape="round" style={{ background: "#e65c00", borderColor: "black" }}>File Report</Button></center><br></br>
