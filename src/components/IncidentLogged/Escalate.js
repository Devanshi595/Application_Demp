...
<Button  onClick={this.showModal}   shape="round" style={{ background: "grey", color: "black" }}>
         Escalate
        </Button>
        <Modal
          title="Escalate"
       ...
       <center> <Button block shape="round" style={{  background: "grey", color: "black"  }} >Escalte</Button></center>
